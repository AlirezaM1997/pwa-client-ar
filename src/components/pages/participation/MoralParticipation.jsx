...
export default function MoralParticipation({
  projectId,
  t,
  tPA,
  showDescription,
  ...
  ///////////////////////FUNCTIONS///////////////////////
  useEffect(() => {
    setDescription(initialFormData?.morlaDescription || "");
    ...
    if (description === "") {
      ...
      try {
        ...
        if (error.message === "Authorization failed" || error.message === "Token required") {
          ...
          saveToStorage("participationType", "MORAL");
        }
      }
    }
  };
      ...
      >
        <header className="lg:hidden">
          ...
          <div className="pt-[14px] pb-[25px]">
            <h1 className="title4 pb-[10px] text-center">{tPA("moralP")}</h1>
            {showDescription && (
              <ShowMoreText
        ...
        <section className="lg:flex lg:items-center lg:gap-x-[30px] xl:gap-x-[60px] 2xl:gap-x-[70px] lg:mt-[55px] ">
          <div className="w-full h-[617px] relative hidden mx-auto lg:block">
            <Image
              src="/assets/images/moral-participation-desktop.png"
              layout="fill"
              quality={100}
              unoptimized
              objectFit="cover"
              alt="moral-participation"
              className=""
            ></Image>
          </div>
          <main className="flex flex-col items-center lg:w-[75%]">
            <div className="w-[290px] h-[275px] relative mx-auto lg:hidden">
              <Image
                src="/assets/images/moral-participation-desktop.png"
                layout="fill"
                alt="moral-participation"
            ...
            <div className="w-full ltr:text-left rtl:text-right mb-[28px] hidden lg:block">
              <div className="flex ltr:flex-col rtl:flex-col-reverse">
                <h2 className="headingDesktop2">{t("requirements.moral")}</h2>
            ...
            <div className="w-full">
              <TextareaInput
                ...
                placeholder={tPA(
                  "participations-placeholder-description.moral.placeholderDescription"
                )}
              />
            </div>
