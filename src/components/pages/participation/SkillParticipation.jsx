...
export default function SkillParticipation({
  projectId,
  t,
  tPA,
  showDescription,
  ...
  ///////////////////////FUNCTIONS///////////////////////
  useEffect(() => {
    setDescription(initialFormData?.skillDescription);
    ...
    if (description === "") {
      ...
      try {
        ...
        if (error.message === "Authorization failed" || error.message === "Token required") {
          ...
          saveToStorage("participationType", "SKILL");
        }
      }
    }
  };
      ...
      >
        <header className="lg:hidden">
          <div className="pt-[14px] pb-[25px]">
            <h1 className="title4 pb-[10px] text-center">{tPA("skillP")}</h1>
            {showDescription && (
              <ShowMoreText
        ...
        <section className="lg:flex lg:items-center lg:gap-x-[30px] xl:gap-x-[60px] 2xl:gap-x-[70px] lg:mt-[55px] ">
          <div className="w-full h-[584px] relative hidden mx-auto lg:block">
            <Image
              src="/assets/images/skill-participation-desktop.png"
              layout="fill"
              quality={100}
              unoptimized
              objectFit="cover"
              alt="skill-participation"
              className=""
            ></Image>
          </div>
          <main className="flex flex-col items-center lg:w-[75%]">
            <div className="w-[328px] h-[250px] relative mx-auto lg:hidden">
              <Image
                src="/assets/images/skill-participation-desktop.png"
                layout="fill"
                alt="skill-participation"
            ...
            <div className="w-full ltr:text-left rtl:text-right mb-[28px] hidden lg:block">
              <div className="flex ltr:flex-col rtl:flex-col-reverse">
                <h2 className="headingDesktop2">{t("requirements.skill")}</h2>
            ...
            <div className="w-full mt-9">
              <TextareaInput
                ...
                placeholder={tPA(
                  "participations-placeholder-description.skill.placeholderDescription"
                )}
              />
            </div>
