 ...
 */
const letters = [
  ["", "واحد", "إثنان", "ثلاثة", "أربعة", "خمسة", "ستة", "سبعة", "ثمانیة", "تسعة"],
  ["عشرة", "أحد عشر", "اثنا عشر", "ثلاثة عشر", "أربعة عشر", "خمسة عشر", "ستة عشر", "سبعة عشر", "ثمانیة عشر", "تسعة عشر", "العِشرون"],
  ["", "", "العِشرون", "الثلاثون", "الأربعون", "الخمسون", "الستّون", "السبعون", "الثمانون", "التسعون"],
  ["", "مائة", "مائتين", "ثلاثمائه", "أربعة مئة", "خمسمائة", "ستمائة", "سبعمائة", "ثمان مائة", "تسعمائة"],
  [
    "",
    " ألف",
    " مليون",
...
const convertDecimalPart = (decimalPart) => {
  ...
  return " ممیز " + numToArabic(decimalPart) + " " + decimalSuffixes[decimalPart.length];
};
...
String.prototype.toPersianLetter = function () {
  return numToArabic(this);
};

Number.prototype.toPersianLetter = function () {
  return numToArabic(parseFloat(this).toString());
};

export default numToArabic;
