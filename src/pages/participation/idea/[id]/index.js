...
import IdeasParticipation from "@components/pages/participation/IdeasParticipation";

export default function IdeaParticipationPage({ params }) {
  ///////////////////////HOOKS///////////////////////
    ...
    <>
      ...
      <div className="flex justify-between px-4 pt-7 lg:hidden">
        ...
        <div
          ...
          onClick={() => {
            toast.remove();
            router.push(`/my-participation/idea/${projectId}`, undefined, { shallow: true });
          }}
        >
