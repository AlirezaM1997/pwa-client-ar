...
import PressenceParticipation from "@components/pages/participation/PressenceParticipation";

export default function PressenceParticipationPage({ params }) {
  ///////////////////////HOOKS///////////////////////
    ...
    <>
      ...
      <div className="flex justify-between px-4 pt-7 lg:hidden">
        ...
        <div
          ...
          onClick={() => {
            toast.remove();
            router.push(`/my-participation/inPerson/${projectId}`, undefined, { shallow: true });
          }}
        >
