...
import MoralParticipation from "@components/pages/participation/MoralParticipation";

export default function MoralParticipationPage({ params }) {
  ///////////////////////HOOKS///////////////////////
    ...
    <>
      ...
      <div className="flex justify-between px-4 pt-7 lg:hidden">
        ...
        <div
          ...
          onClick={() => {
            toast.remove();
            router.push(`/my-participation/moral/${projectId}`, undefined, { shallow: true });
          }}
        >
